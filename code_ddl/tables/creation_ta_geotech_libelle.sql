...
COMMENT ON COLUMN G_GEO.TA_GEOTECH_LIBELLE.FID_LIBELLE_LONG IS 'Clé étrangère vers la table TA_GEOTECH_LIBELLE_LONG permettant d''associer un libelle long à un libelle.';
