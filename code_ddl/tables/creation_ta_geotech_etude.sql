...
COMMENT ON COLUMN G_GEO.TA_GEOTECH_ETUDE.FID_PHASE_ETUDE IS 'Clé étrangère vers la table TA_GEOTECH_LIBELLE permettant d''associer une étude à sa phase d''avancement.';
...
ALTER TABLE G_GEO.TA_GEOTECH_ETUDE
ADD CONSTRAINT TA_GEOTECH_ETUDE_FID_PHASE_ETUDE_FK
FOREIGN KEY("FID_PHASE_ETUDE")
REFERENCES G_GEO.TA_GEOTECH_LIBELLE("OBJECTID");
...
CREATE INDEX TA_GEOTECH_ETUDE_FID_PHASE_ETUDE_IDX ON G_GEO.TA_GEOTECH_ETUDE("FID_PHASE_ETUDE")
    TABLESPACE G_ADT_INDX;
